...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ubiq", "github.com/athofficial/go-ath/mobile")
	...
	if err = ioutil.WriteFile(filepath.Join("src", "androidTest", "java", "org", "ubiq", "gathtest", "AndroidTest.java"), []byte(androidTestClass), os.ModePerm); err != nil {
