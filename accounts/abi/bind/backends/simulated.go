...
func NewSimulatedBackend(alloc core.GenesisAlloc, gasLimit uint64) *SimulatedBackend {
	...
	genesis := core.Genesis{Config: params.AllUbqhashProtocolChanges, GasLimit: gasLimit, Alloc: alloc}
	genesis.MustCommit(database)
	blockchain, _ := core.NewBlockChain(database, nil, genesis.Config, ubqhash.NewFaker(), vm.Config{}, nil)
...
func (b *SimulatedBackend) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	blocks, _ := core.GenerateChain(b.config, b.blockchain.CurrentBlock(), ubqhash.NewFaker(), b.database, 1, func(number int, block *core.BlockGen) {
