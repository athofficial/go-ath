...
people to build go-atheios using the standard toolchain without any particular package
...
To allow reproducible builds of go-atheios nonetheless that don't need network access
...
We want to build go-atheios with the most recent version of Go, irrespective of the Go
