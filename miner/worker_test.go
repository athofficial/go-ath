...
func TestPendingStateAndBlockUbqhash(t *testing.T) {
	testPendingStateAndBlock(t, ubqhashChainConfig, ubqhash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	...
	w, b := newTestWorker(t, ubqhashChainConfig, ubqhash, 1)
	defer w.close()
