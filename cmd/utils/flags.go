...
import (
	...
	"github.com/athofficial/go-ath/common/fdlimit"
...
var (
	...
	UbqhashDatasetDirFlag = DirectoryFlag{
		Name:  "ubqhash.dagdir",
		Usage: "Directory to store the ubqhash mining DAGs (default = inside home folder)",
...
// RegisterEthService adds an Ubiq client to the stack.
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gath.", tagsMap)
		}
	}
}
