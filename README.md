 ...
 * Instead of using the default data directory (`~/.ubiq` on Linux for example), gath will nest
...
As a developer, sooner rather than later you'll want to start interacting with gath and the Ubiq
