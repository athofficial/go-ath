...
import (
	...
	"github.com/atheioschain/go-atheios/eth/fetcher"
...
func (pm *ProtocolManager) Stop() {
	glog.V(logger.Info).Infoln("Stopping atheios protocol handler...")
	...
	glog.V(logger.Info).Infoln("atheios protocol handler stopped")
}
